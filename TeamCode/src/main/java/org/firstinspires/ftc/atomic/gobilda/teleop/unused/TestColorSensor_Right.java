...
public class TestColorSensor_Right extends LinearOpMode {
  ...
  public void runOpMode() {
    ...
    colorSensor = hardwareMap.get(ColorSensor.class, ConfigConstants.RIGHT_COLOR);
    colorSensor.enableLed(true);

    distanceSensor = hardwareMap.get(DistanceSensor.class, ConfigConstants.RIGHT_COLOR);
